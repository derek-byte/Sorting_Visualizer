...
def home():
    ...
    if request.method == "POST":
        ...
        new_sort = Sort(title=id, past_array=str(array), steps_array=array_str)
...
def create_csv():
    ...
    for new_sort in sort_list[::-1]:
        csv_arr.append([new_sort.id, new_sort.title, new_sort.past_array, new_sort.steps_array])
